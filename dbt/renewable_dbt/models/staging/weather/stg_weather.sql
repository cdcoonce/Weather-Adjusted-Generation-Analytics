...
transformed AS (
    SELECT
        ...
        ROUND(wind_speed_mps::FLOAT, 2) AS wind_speed_mps,
        ROUND(wind_direction_deg::FLOAT, 1) AS wind_direction_deg,
        ROUND(ghi::FLOAT, 2) AS ghi,
        ROUND(temperature_c::FLOAT, 2) AS temperature_c,
        ROUND(pressure_hpa::FLOAT, 1) AS pressure_hpa,
        ROUND(relative_humidity::FLOAT, 1) AS relative_humidity,
